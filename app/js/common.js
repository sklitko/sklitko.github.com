...
$(function() {
  ...
  var listImages = [
    './images/icons/ua2.png',
    './images/icons/tw2.png',
    './images/icons/support2.png',
    './images/icons/ru2.png',
    './images/icons/lang2.png',
    './images/icons/insta2.png',
    './images/icons/g+2.png',
    './images/icons/fb2.png',
    './images/icons/en2.png'
  ]

  listImages.forEach(function(elem, item) {
    preloadImages(elem)
  })
